package com.example.user.myapplication1214_2;
        ...
        implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener
{
    ...
    public void clickFood(View v)
    {
        ...
        StringRequest request = new StringRequest(
                "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=" +mLastLocation.getLatitude() +"," + mLastLocation.getLongitude() + "&radius=500&types=food&key=AIzaSyAastGyLh5UMh03t7psCIorlcXBGUGxY-8",
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for(int i=0; i < array.length() ; i++)
                            {
                                ...
                                String con = detail.getString("icon");
                                Log.d("LOC","附近食物:" + n +","+con);
                            }
